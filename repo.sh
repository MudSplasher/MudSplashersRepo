...
apt-ftparchive \
		-o APT::FTPArchive::Release::Origin="MudSplashers Repo" \
		-o APT::FTPArchive::Release::Label="MudSplashers Repo" \
		...
		-o APT::FTPArchive::Release::Description="MudSplashers Repo " \
		release . > Release
